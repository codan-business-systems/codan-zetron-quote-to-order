sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("dyflex/sd/sales/quotation/app", ".html");
			sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

			if (sHash) {
				sHash = "#SalesQuotation-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
			} else {
				sHash = "#SalesQuotation-display";
			}

			return sUrl + sUrlParameters + sHash;
		}

		return Opa5.extend("dyflex.sd.sales.quotation.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["dyflex/sd/sales/quotation/localService/mockserver"], function (mockserver) {
